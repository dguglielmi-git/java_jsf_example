...
/**
 * Con las anotaciones @Named y el alcance RequestScoped sera reconocido por el
 * framework de JSF y así se puede utilizar desde las paginas del framework
 * 
 * @Named declara el bean para luego ser inyectado (instanciado) con @Inject
